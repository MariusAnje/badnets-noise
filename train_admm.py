...
def main():
    ...
    data_loader_train_poisoned_file, data_loader_val_clean_file, data_loader_val_poisoned_file = get_poision_datasets(args, args.batch_size, args.num_workers)
    ...
    data_loader_train_clean, data_loader_train_poisoned, data_loader_val_clean, data_loader_val_poisoned = \
        get_memory_dataset([data_loader_train_clean_file, data_loader_train_poisoned_file,
                            data_loader_val_clean_file, data_loader_val_poisoned_file])
